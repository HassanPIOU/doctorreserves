        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Services (Département)</h4>
                </div>
                    ...
                    @if(count($services) == 0)
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-lg-12">
                                        <h4 class="text-center" style="padding: 100px;">Liste des Services (Département) vide</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach($services as $service)
                                        <tr>
                                            ...
                                            <td  style="width: 10%;">
                                                ...
                                                @elseif($service->statut == 2)
                                                    <span  class="badge badge-danger">Inactif</span>
                                                @endif
                                            </td>
                                            <td  style="width: 10%;">
                                                @if($service->statut == 2)
                                                    <a href="javascript:void(0)" class="btn btn-sm btn-success" onclick="actionMedecine('{{$service->id}}','1','service')"> <i class="icon-check text-white" title="Activer"></i></a>
                                                @elseif($service->statut == 1)
                                                    <a href="javascript:void(0)"  class="btn btn-sm btn-warning" onclick="actionMedecine('{{$service->id}}','2','service')"> <i class="icon-close text-white" title="Désactivé"></i></a>
                                                @endif
                                                <a href="javascript:void(0)"  class="btn btn-sm btn-danger" onclick="actionMedecine('{{$service->id}}','3','service')"><i class="icon-trash text-white" title="Supprimer"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
